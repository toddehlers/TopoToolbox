...
%
    ...
    [telev2, idex] = unique(telev);

    ida = interp1(telev2, drainarea(idex), ielev);
    idfd = interp1(telev2, dfd(idex), ielev);
    idfm = max(dfd) - idfd;
...
%
    ...
    ida2 = interp1(telev2, drainarea(idex), ielev2);
    idfd2 = interp1(telev2, dfd(idex), ielev2);
